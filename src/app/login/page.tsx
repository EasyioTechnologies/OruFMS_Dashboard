  ...
  return (
    <main className="container" style={{ paddingTop: '8rem', paddingBottom: '8rem', maxWidth: '600px' }}>
      <div style={{ border: '2px solid var(--ink)', padding: '4rem 3rem', backgroundColor: 'var(--paper)' }}>
        <h1 style={{ marginBottom: '1rem', fontSize: '2rem', textAlign: 'center' }}>CLIENT ACCESS</h1>
        <p style={{ textAlign: 'center', marginBottom: '3rem', opacity: 0.7 }}>Log in to manage your licenses.</p>
        ...
        <div style={{ marginTop: '2rem', textAlign: 'center', fontSize: '0.875rem' }}>
          No account yet? <Link href="/signup" style={{ fontWeight: 800 }}>Register Here</Link>
        </div>
      </div>
    </main>
  );
